...
class ReorgStakeTest(c_noteTestFramework):
    ...
    def check_money_supply(self, expected_pro):
        # verify that nodes have the expected CNOTE supply
    ...
    def run_test(self):
        ...
        # Verify that CNOTE supply was properly updated after the reorgs
        self.log.info("Check CNOTE supply...")
