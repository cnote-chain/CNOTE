Contributing to C_Note
============================

The C_Note project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/c_note-project/c_note/blob/master/doc/translation_process.md)
...
The following applies to code changes to the C_Note project, and is not to be
confused with overall C_Note Network Protocol consensus changes.

Whether a pull request is merged into C_Note rests with the project merge
...
Patches that change C_Note consensus rules are considerably more involved than
...
Where a patchset proposes to change the C_Note consensus, it must have been
...
The project leader is the release manager for each C_Note release.
