...
class BlockIndexStatsTest(c_noteTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 CNOTE "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 CNOTE + 9 notes of 5 CNOTE + 1 note of 4 CNOTE (using 1.0 fee)
