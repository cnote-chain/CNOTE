...
extern const char * const C_Note_CONF_FILENAME;
extern const char * const C_Note_PID_FILENAME;
extern const char * const C_Note_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("c_note-%s", name);
