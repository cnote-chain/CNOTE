...
#include "qt/c_note/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(C_NoteGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("C_Note_tx_csv_export(*.csv)") : tr("C_Note_addresses_csv_export(*.csv)"),
        nullptr);
