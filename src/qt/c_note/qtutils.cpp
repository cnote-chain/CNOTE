...
void closeDialog(QDialog* widget, C_NoteGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, C_NoteGUI* gui, double posX, int posY)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackground(QDialog* widget, C_NoteGUI* gui, double posX)
{
    return openDialogWithOpaqueBackgroundY(widget, gui, posX, 5);
}

bool openDialogWithOpaqueBackgroundFullScreen(QDialog* widget, C_NoteGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
...
{
    if (isSelected) {
        return QColor("#251A2A33");
    } else if (isHovered) {
        return QColor("#25bababa");
    } else {
        return isLightTheme ? QColor("#ffffff") : QColor("#282F33");
    }
}
