...
"""Verify that starting c_note with -h works as expected."""
import subprocess

from test_framework.test_framework import c_noteTestFramework
from test_framework.util import assert_equal

class HelpTest(c_noteTestFramework):
    ...
    def run_test(self):
        self.log.info("Start c_note with -? for help text")
        ...
        self.log.info("Start c_note with -version for version information")
