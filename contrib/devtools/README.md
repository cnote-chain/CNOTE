...
Provides utilities for managing copyright headers of `The C_Note
...
C_Note-Project/C_Note repository.
...
Setup
---------
Configuring the github-merge tool for the C_Note repository is done in the following way:

    git config githubmerge.repository C_Note-Project/C_Note
...
A script to optimize png files in the C_Note
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_c_note: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_c_note: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_c_note: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_c_note: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
