...
#include "qt/c_note/forms/ui_addresseswidget.h"
#include "qt/c_note/addresslabelrow.h"
#include "qt/c_note/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(C_NoteGUI* parent) :
    PWidget(parent),
