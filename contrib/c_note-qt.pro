...
RESOURCES += src/qt/c_note.qrc src/qt/c_note_locale.qrc

TRANSLATIONS += src/qt/locale/c_note_bg.ts \
                src/qt/locale/c_note_de.ts \
                src/qt/locale/c_note_en.ts \
                src/qt/locale/c_note_es.ts \
                src/qt/locale/c_note_fi.ts \
                src/qt/locale/c_note_fr.ts \
                src/qt/locale/c_note_it.ts \
                src/qt/locale/c_note_ja.ts \
                src/qt/locale/c_note_pl.ts \
                src/qt/locale/c_note_pt.ts \
                src/qt/locale/c_note_ru.ts \
                src/qt/locale/c_note_sk.ts \
                src/qt/locale/c_note_sv.ts \
                src/qt/locale/c_note_vi.ts \
                src/qt/locale/c_note_zh_CN.ts \
                src/qt/locale/c_note_zh_TW.ts
