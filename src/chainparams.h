 ...
 * C_Note system. There are three: the main network on which people trade goods
...
public:
    ...
    {
        if (nHeight <= 2000) {
            return "CJi4DVgf7XWw8kVCZkju6DNQbV2HpqRh2q";
        }  else {
            return "CPZPjKt9Bm6CAiV3ycS8dd4W5toJPbJive";
        }
    }
