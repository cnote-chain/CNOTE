...
This document provides guidelines for internationalization of the C_Note software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to C_Note network</source>
        <translation>
            <numerusform>%n active connection to C_Note network</numerusform>
            <numerusform>%n active connections to C_Note network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `c_note_en.ts` remains unchanged.
