...
#include "qt/c_note/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/c_note/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(C_NoteGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to C_NoteGUI::handleRestart()
