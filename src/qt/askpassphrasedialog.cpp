...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            C_NoteGUI* window = static_cast<C_NoteGUI*>(parentWidget());
...
{
    C_NoteGUI* gui = static_cast<C_NoteGUI*>(parentWidget());
...
{
    hide();
    static_cast<C_NoteGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("C_Note will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your CNOTEs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
