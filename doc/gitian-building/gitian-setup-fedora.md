...
The build script we'll be using is contained in the C_Note github repository ([contrib/gitian-build.py](https://github.com/c_note-project/c_note/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the C_Note repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/C_Note-Project/C_Note/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, c_note-detached-sigs, and c_note GitHub repos.
