...
The script [extract-osx-sdk.sh](https://github.com/c_note-project/c_note/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
c_note/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/c_note-project/c_note/blob/master/doc/README_osx.md) for troubleshooting tips.
