...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(CNOTE);
    unitlist.append(mCNOTE);
    unitlist.append(uCNOTE);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case CNOTE:
        return QString("c_note");
    case mCNOTE:
        return QString("mc_note");
    case uCNOTE:
        return QString::fromUtf8("uc_note");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros)
{
    ...
    // Always show at least 8 decimals for CNOTE
    if (unit == CNOTE && digits < 8) digits = 8;
