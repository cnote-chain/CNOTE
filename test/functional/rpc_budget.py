...
class BudgetProposalTest(c_noteTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid C_Note address")
        assert_raises_rpc_error(-5, "Invalid C_Note address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 CNOTE allowed" % invalid_amt, self.nodes[0].preparebudget,
