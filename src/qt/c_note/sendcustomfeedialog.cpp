...
#include "qt/c_note/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(C_NoteGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &C_NoteGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
