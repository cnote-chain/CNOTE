...
#include "qt/c_note/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(C_NoteGUI* _window, QWidget *parent) :
