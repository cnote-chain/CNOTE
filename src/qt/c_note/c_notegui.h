...
#ifndef C_Note_CORE_NEW_GUI_C_NoteGUI_H
#define C_Note_CORE_NEW_GUI_C_NoteGUI_H
...
#include "qt/c_note/navmenuwidget.h"
#include "qt/c_note/topbar.h"
#include "qt/c_note/dashboardwidget.h"
#include "qt/c_note/send.h"
#include "qt/c_note/receivewidget.h"
#include "qt/c_note/addresseswidget.h"
#include "qt/c_note/coldstakingwidget.h"
#include "qt/c_note/masternodeswidget.h"
#include "qt/c_note/snackbar.h"
#include "qt/c_note/settings/settingswidget.h"
...
/**
  C_Note GUI main class. This class represents the main window of the C_Note UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class C_NoteGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit C_NoteGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~C_NoteGUI();
...
#endif //C_Note_CORE_NEW_GUI_C_NoteGUI_H
