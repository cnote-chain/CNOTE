...
/** Utility functions used by the C_Note Qt UI.
 */
namespace GUIUtil
{
...
// Render C_Note addresses in monospace font
...
// Parse "c_note:" URI into recipient object, return true on successful parsing
