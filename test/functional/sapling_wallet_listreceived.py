...
class ListReceivedTest (c_noteTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 CNOTE.
        ...
        # Send 1 CNOTE to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 CNOTE sending them all (fee is 0.1 CNOTE)
        ...
        # Confirm transaction (2 CNOTE from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 CNOTE, send 0.6 CNOTE + 0.05 CNOTE fee
