                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("C-Note") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About C-Note"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #F3B307;text-decoration:none'  href=\"\\1\">\\1</a>");
        ...
        QString header = tr("Usage:") + "\n" +
                         "  c_note-qt [" + tr("command-line options") + "]                     " + "\n";
