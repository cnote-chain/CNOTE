...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, C_NoteGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, C_NoteGUI* gui, double posX = 3);
