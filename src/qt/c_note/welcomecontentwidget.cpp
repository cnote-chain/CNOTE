...
#include "qt/c_note/forms/ui_welcomecontentwidget.h"
    ...
    nextButton(new QPushButton())
{
    ...
    backButton->setStyleSheet("background: url(://ic-arrow-white-left); background-repeat:no-repeat;background-position:center;border:  0;background-color:#F3B307;color: #F3B307; border-radius:2px;");
    nextButton->move(nextX, nextY);
    nextButton->setStyleSheet("background: url(://ic-arrow-white-right);background-repeat:no-repeat;background-position:center;border:  0;background-color:#F3B307;color: #F3B307; border-radius:2px;");
