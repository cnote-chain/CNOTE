...
from test_framework.test_framework import c_noteTier2TestFramework
...
class MasternodeGovernanceBasicTest(c_noteTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.c_note.org/t/test-proposal"
