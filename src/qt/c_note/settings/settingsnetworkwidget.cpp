...
#include "qt/c_note/settings/settingsnetworkwidget.h"
#include "qt/c_note/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/c_note/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(C_NoteGUI* _window, QWidget *parent) :
