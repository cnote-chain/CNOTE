...
//
// The Masternode Class. It contains the input of the Collateral Amount of CNOTE, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is Collateral Amount of CNOTE - checking if valid masternode)
