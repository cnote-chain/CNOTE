...
#ifndef C_Note_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define C_Note_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //C_Note_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
